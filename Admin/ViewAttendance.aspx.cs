...
public partial class Admin_ViewAttendance : System.Web.UI.Page
{
    ...
    {
        aud.AuditLog(EncryptHelper.Encrypt("Attendance Report", Helper.GetSalt()), int.Parse(Session["empid"].ToString()), EncryptHelper.Encrypt("Generated by employee", Helper.GetSalt()));
    }
