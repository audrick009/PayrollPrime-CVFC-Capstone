...
public partial class Admin_ViewAuditLog : System.Web.UI.Page
{
    ...
    {
        getReportEmp();
        aud.AuditLog(EncryptHelper.Encrypt("Audit logs Report", Helper.GetSalt()), int.Parse(Session["empid"].ToString()), EncryptHelper.Encrypt("Generated by employee", Helper.GetSalt()));
