...
public partial class Employee_ViewPayslip : System.Web.UI.Page
{
    ...
    protected void btnGenRep_Click(object sender, EventArgs e)
    {
        ...
        aud.AuditLog(EncryptHelper.Encrypt("Generate Payslip", Helper.GetSalt()), int.Parse(Session["empid"].ToString()), EncryptHelper.Encrypt(name + " Generated his/her own Payslip", Helper.GetCon()));
    }
}