<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/DepartmentHead.master" AutoEventWireup="true" CodeFile="DPChangePassword.aspx.cs" Inherits="DepartmentHead_DPChangePassword" %>
        ...
        <div class="col-lg-6 centered">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-8">
                    <asp:TextBox ID="ReEnterNP" runat="server" textmode="Password" class="form-control" required />
